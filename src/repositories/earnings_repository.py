...
class EarningsRepository(TimeRangeCSVRepository[EarningsReport]):
    ...
    def __init__(
        ...
        # Daily earnings files directory
    ...
    async def add_daily_report(
        ...
        """
        # Create daily repository if needed
        ...
        try:
            ...
            raise StorageError(
                f"Failed to add daily report: {str(e)}"
            ) from e
    ...
    async def get_missing_dates(
        ...
        report_dates = set(r.report_date.date() for r in reports)
        
        # Return missing dates
        return sorted(list(all_dates - report_dates))